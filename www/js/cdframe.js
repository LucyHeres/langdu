...
//绑定事件
var Actions = {
    action: function (event, $this, action_name,para) {
    ...
    click:function(event){
        ...
        return Actions.action(event, $this, $this.data('click'),$this.data('para'))
    },
    //以下为点击事件时调用的通用方法，如果当前组件的CDctrl中没有时，则调用这里的通用方法
    goto:function($this){
